...
#define KRN_FrameBuffer         (KRN_Dummy + 33) /* Linear framebuffer physical base address */
...
#define KATTR_FrameBuffer       (KATTR_CPULoad_END + 2) /* [.G] (APTR)    - Linear framebuffer base address (embedded targets)          */
#define KATTR_FrameBufferWidth  (KATTR_CPULoad_END + 3) /* [.G] (IPTR)    - Framebuffer width in pixels                                 */
