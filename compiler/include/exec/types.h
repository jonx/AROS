...
#   define __typedef_ULONG
    typedef unsigned AROS_32BIT_TYPE            ULONG;
#endif
#endif
...
#ifndef __typedef_WSTRPTR
#   define __typedef_WSTRPTR
    typedef unsigned AROS_32BIT_TYPE            *WSTRPTR;    /* Pointer to a wide string (NULL terminated) */
#endif
...
#ifndef __typedef_CONST_WSTRPTR
#   define __typedef_CONST_WSTRPTR
    typedef unsigned AROS_32BIT_TYPE            *CONST_WSTRPTR;/* Pointer to constant wide string (NULL terminated) */
#endif
...
#   define __typedef_RAWARG
    typedef struct RAWARG_s { }                 *RAWARG;    /* Type of 'datastream' of RawDoFmt */
#endif
