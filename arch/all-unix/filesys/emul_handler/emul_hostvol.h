...
/* AROS overlay sidecar I/O (file access via the dlsym'd LibCInterface). */
struct emulbase;
 ...
 * I/O/parse error. Caller must NOT hold HostLib_Lock(). */
...
/* Keep the sidecar paired with its data file across rename/delete. */
